...
1499970과 같이 큰 오프셋으로 게시글을 조회하면 아래와 같이 10.22s가 걸리는 것을 확인할 수 있다.   
실행 계획을 보면 인덱스를 사용했지만 조회 하는데 많은 시간이 걸렸다.   

![6 오프셋 1499970 조회](https://i.imgur.com/LoJUgmP.png)

![7 오프셋 1499970 실행계획](https://i.imgur.com/6Gb1NL0.png)
